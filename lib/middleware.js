...
exports.default = ({
    ...
    const authorized = (() => {
        var _ref2 = (0, _asyncToGenerator3.default)(function* (ctx) {
            try {
                ...
                // Fetch user details
                const response = yield (0, _nodeFetch2.default)(`${userUrl}?access_token=${accessToken.token.access_token}`, {
                    method: userMethod
                });
                if (response.ok) {
                    // Parse response
    ...
    const isLoggedIn = (() => {
        ...
        return function isLoggedIn(_x5, _x6) {
    ...
    const requireLogin = (() => {
        ...
        return function requireLogin(_x7, _x8) {
