...
exports.default = ({
    ...
    const refreshToken = (() => {
        var _ref3 = (0, _asyncToGenerator3.default)(function* (ctx, next) {
            ctx.state.refreshToken = (0, _asyncToGenerator3.default)(function* () {
    ...
    const isLoggedIn = (() => {
        ...
        return function isLoggedIn(_x7, _x8) {
    ...
    const requireLogin = (() => {
        ...
        return function requireLogin(_x9, _x10) {
